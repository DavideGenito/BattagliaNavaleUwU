...
namespace BattagliaNavale.Views
{
    public partial class Gioco : ContentPage
    {
        ...
        private async void PlayBackgroundMusic()
        {
            ...
            if (Player2 == null)
            {
                var file = await FileSystem.OpenAppPackageFileAsync("jack-sparrow_dFQte8NI.mp3");
                Player2 = _audioManager.CreatePlayer(file);
                Player2.Loop = true;
            }
